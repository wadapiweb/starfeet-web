  ...
  return (
    <section className="space-y-6">
      ...
      <article className="rounded-2xl border border-gray-200 bg-white p-5">
        <h3 className="font-condensed text-2xl font-bold uppercase text-starfeet-blue">Inventario por talle</h3>
          ...
          <table className="w-full min-w-[520px] text-left text-sm">
            ...
            <tbody>
              {product.inventories.length === 0 ? (
                <tr>
                  <td colSpan={4} className="px-3 py-4 text-gray-500">Sin inventario cargado.</td>
                </tr>
              ) : (
