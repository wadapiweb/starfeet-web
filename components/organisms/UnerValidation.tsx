...
export const UnerValidation = () => {
  ...
  return (
    <section 
      ...
      className="relative bg-[#09224b] text-white py-20 lg:py-28 overflow-hidden border-t border-[#0d2e61]"
    >
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <motion.div 
          ...
          className="lg:col-span-7 flex flex-col gap-6 md:gap-8 z-10"
        >
        ...
        <div className="lg:col-span-5 relative w-full h-[320px] sm:h-[420px] lg:h-[520px] flex items-end justify-center lg:justify-end z-0">
          <div className="relative w-full h-full max-w-[320px] sm:max-w-[400px] lg:max-w-[450px]">
            <Image
